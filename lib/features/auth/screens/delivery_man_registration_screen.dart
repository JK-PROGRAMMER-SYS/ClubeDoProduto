...
class _DeliveryManRegistrationScreenState extends State<DeliveryManRegistrationScreen> {
  ...
  void initState() {
    ...
    Get.find<DeliverymanRegistrationController>().setIdentityTypeIndex(
        Get.find<DeliverymanRegistrationController>().identityTypeList[0], false);
        ...
        body: SafeArea(
          child: GetBuilder<DeliverymanRegistrationController>(builder: (deliverymanController) {
            ...
            List<DropdownItem<int>> identityTypeList =
                _generateDropDownIdentityTypeList(deliverymanController.identityTypeList);
                                  ...
                                  children: [
                                    Visibility(
                                      ...
                                      child: Form(
                                        ...
                                        child: Column(children: [
                                          Row(children: [
                                            Text('deliveryman_info'.tr,
                                                style: robotoBold.copyWith(
                                                    fontSize: Dimensions.fontSizeLarge)),
                                            const SizedBox(width: Dimensions.paddingSizeSmall),
                                            CustomToolTip(
                                              message:
                                                  'this_info_will_need_for_delivery_app_login'.tr,
                                                ...
                                                child: Column(children: [
                                                  ...
                                                  Stack(clipBehavior: Clip.none, children: [
                                                    ClipRRect(
                                                      ...
                                                      child: deliverymanController.pickedImage !=
                                                              null
                                                          ? GetPlatform.isWeb
                                                              ? Image.network(
                                                    ...
                                                    deliverymanController.pickedImage != null
                                                        ? Positioned(
                                                            bottom: -10,
                                                            right: -10,
                                                            child: InkWell(
                                    ...
                                    Visibility(
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: Column(children: [
                                                Row(children: [
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: CustomDropdown<int>(
                                                        onChange: (int? value, int index) {
                                                          deliverymanController.setDMTypeIndex(
                                                              index, true);
                                                        },
                                                        ...
                                                        child: Text(
                                                          deliverymanController
                                                              .dmTypeList[deliverymanController
                                                                  .dmTypeIndex]!
                                                              .tr,
                                                          style: robotoRegular.copyWith(
                                                              color: Theme.of(context)
                                                  ...
                                                  Expanded(
                                                      child: (deliverymanController.zoneList !=
                                                                  null &&
                                                              deliverymanController
                                                                      .selectedZoneIndex !=
                                                                  -1)
                                                ...
                                                const SizedBox(
                                                    height: Dimensions.paddingSizeOverLarge),
                                                deliverymanController.vehicleIds != null
                                                    ? Container(
                                                        decoration: BoxDecoration(
                                                            borderRadius: BorderRadius.circular(
                                                                Dimensions.radiusDefault),
                                                        ...
                                                        child: CustomDropdown<int>(
                                                          onChange: (int? value, int index) {
                                                            deliverymanController.setVehicleIndex(
                                                                index, true);
                                                          },
                                                          indexZeroNotSelected: true,
                                                          dropdownButtonStyle: DropdownButtonStyle(
                                                          ...
                                                          child: Text(
                                                            deliverymanController
                                                                .vehicles![deliverymanController
                                                                    .vehicleIndex!]
                                                                .type!
                                                                .tr,
                                                            style: robotoRegular.copyWith(
                                                ...
                                                Container(
                                                  ...
                                                  child: CustomDropdown<int>(
                                                    onChange: (int? value, int index) {
                                                      deliverymanController.setIdentityTypeIndex(
                                                          deliverymanController
                                                    ...
                                                    child: Text(
                                                      deliverymanController
                                                          .identityTypeList[deliverymanController
                                                              .identityTypeIndex]
                                                          .tr,
                                                      style: robotoRegular.copyWith(
                                                          color: Theme.of(context)
                                                ...
                                                CustomTextFieldWidget(
                                                  titleText: deliverymanController
                                                          ...
                                                          0
                                                      ? 'Ex: XXXXX-XXXXXXX-X'
                                                      : deliverymanController.identityTypeIndex == 1
                                                          ? 'L-XXX-XXX-XXX-XXX.'
                                                          : 'XXX-XXXXX',
                                                  ...
                                                  validator: (value) =>
                                                      ValidateCheck.validateEmptyText(value,
                                                          "identity_number_field_is_required".tr),
                                                ),
                                                const SizedBox(
                                                    height: Dimensions.paddingSizeOverLarge),
                                                ListView.builder(
                                            ...
                                            const SizedBox(height: Dimensions.paddingSizeLarge),
                                            deliverymanController.dataList!.isNotEmpty
                                                ? Padding(
                                                    padding: const EdgeInsets.only(
    ...
    return GetBuilder<DeliverymanRegistrationController>(builder: (deliverymanController) {
      return Container(
        ...
        child: CustomButtonWidget(
          ...
          buttonText:
              (deliverymanController.dmStatus == 0.1 && !ResponsiveHelper.isDesktop(context))
                  ? 'next'.tr
                  : 'submit'.tr,
          margin: EdgeInsets.all((ResponsiveHelper.isDesktop(context) || ResponsiveHelper.isWeb())
              ? 0
              : Dimensions.paddingSizeSmall),
          height: 50,
          onPressed: !deliverymanController.acceptTerms
              ? null
              : () async {
  ...
  void _addDeliveryMan(DeliverymanRegistrationController deliverymanController) async {
      ...
      for (DataModel data in deliverymanController.dataList!) {
        ...
        if (isTextField) {
          ...
          if (deliverymanController.additionalList![index].text != '') {
            additionalData
                .addAll({data.inputData!: deliverymanController.additionalList![index].text});
          } else {
            if (isRequired) {
    ...
    if (deliverymanController.dmTypeIndex == 0) {
      ...
      data.addAll(DeliveryManBodyModel(
        ...
        identityType:
            deliverymanController.identityTypeList[deliverymanController.identityTypeIndex],
        earning: deliverymanController.dmTypeIndex == 1 ? '1' : '0',
        zoneId:
            deliverymanController.zoneList![deliverymanController.selectedZoneIndex!].id.toString(),
        vehicleId:
            deliverymanController.vehicles![deliverymanController.vehicleIndex!].id.toString(),
      ).toJson());
            ...
            child: SizedBox(
              child: Padding(
                ...
                child: Text(
                  ...
                  style:
                      robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color),
                ),
              ),
            )));
      }
