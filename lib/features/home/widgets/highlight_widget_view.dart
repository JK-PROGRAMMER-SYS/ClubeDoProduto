                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text('see_our_most_popular_restaurant_and_foods'.tr,
                    ...
                    CarouselSlider.builder(
                      ...
                      options: CarouselOptions(
                        ...
                        onPageChanged: (index, reason) {
                          ...
                          if (advertisementController.advertisementList?[index].addType ==
                              "video_promotion") {
                      ...
                      itemBuilder: (context, index, realIndex) {
                        return advertisementController.advertisementList?[index].addType ==
                                'video_promotion'
            ...
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  ...
                  (advertisement.isRatingActive == 1 || advertisement.isReviewActive == 1)
                      ? Positioned(
                          right: 10,
                          bottom: 10,
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                advertisement.isRatingActive == 1
                                    ? Text('${advertisement.averageRating?.toStringAsFixed(1)}',
                                        style:
                                            robotoBold.copyWith(color: Theme.of(context).cardColor))
                                    : const SizedBox(),
                                SizedBox(width: advertisement.isRatingActive == 1 ? 5 : 0),
                                advertisement.isReviewActive == 1
                                    ? Text('(${advertisement.reviewsCommentsCount})',
                                        style: robotoRegular.copyWith(
                                            color: Theme.of(context).cardColor))
                                    : const SizedBox(),
                              ],
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      GetBuilder<FavouriteController>(builder: (favouriteController) {
                        bool isWished =
                            favouriteController.wishRestIdList.contains(advertisement.restaurantId);
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child:
                          Icon(Icons.arrow_forward, color: Theme.of(context).cardColor, size: 20),
                    ),
                  ),
                ]),
              ]),
...
class AdvertisementIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AdvertisementController>(builder: (advertisementController) {
      return advertisementController.advertisementList != null &&
              advertisementController.advertisementList!.length > 2
          ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Row(
                ...
                children: advertisementController.advertisementList!.map((advertisement) {
                  ...
                  return index == advertisementController.currentIndex
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(50)),
                          child: Text(
                            "${index + 1}/ ${advertisementController.advertisementList!.length}",
    ...
    return Shimmer(
      child: Container(
        ...
        margin: EdgeInsets.only(
          ...
          right: Get.find<LocalizationController>().isLtr && ResponsiveHelper.isDesktop(context)
              ? Dimensions.paddingSizeLarge
              : 0,
          left: !Get.find<LocalizationController>().isLtr && ResponsiveHelper.isDesktop(context)
              ? Dimensions.paddingSizeLarge
              : 0,
        ),
        child: Padding(
                                        ...
                                        InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            padding: const EdgeInsets.symmetric(
                                                horizontal: Dimensions.paddingSizeSmall + 5,
