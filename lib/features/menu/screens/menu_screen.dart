                    ...
                    child: Column(children: [
                      PortionWidget(
                        ...
                        title: Get.find<AuthController>().isLoggedIn()
                            ? 'profile'.tr
                            : 'continue_single'.tr,
                        route: Get.find<AuthController>().isLoggedIn()
                    ...
                    child: Column(children: [
                      ...
                      (Get.find<SplashController>().configModel!.customerWalletStatus == 1)
                          ? PortionWidget(
                              ...
                              suffix: !isLoggedIn
                                  ? null
                                  : PriceConverter.convertPrice(profileController.userInfoModel !=
                                          null
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text(Get.find<AuthController>().isLoggedIn() ? 'logout'.tr : 'sign_in'.tr,
                          style: robotoMedium)
                    ]),
                  ),
                ),
