                  ...
                  itemBuilder: (context, index, _) {
                    return Container(
                      ...
                      padding: EdgeInsets.all(Dimensions.paddingSizeSmall -
                          (scrollingRate * (isDesktop ? 2 : Dimensions.paddingSizeSmall))),
                      ...
                      child: Row(children: [
                            ...
                            child: Column(
                              ...
                              Row(children: [
                                  ...
                                  child: Text(
                                    ...
                                    style: robotoMedium.copyWith(
                                        fontSize: Dimensions.fontSizeDefault -
                                            (scrollingRate *
                                                (isDesktop ? 2 : Dimensions.fontSizeDefault)),
                                ...
                                InkWell(
                                  ...
                                  child: Icon(Icons.copy_rounded,
                                      size: 16 - (scrollingRate * (isDesktop ? 2 : 16)),
                              ...
                              SizedBox(
                                  height: Dimensions.paddingSizeExtraSmall -
                                      (scrollingRate *
                                          (isDesktop ? 2 : Dimensions.paddingSizeExtraSmall))),
                              Text(
                                ...
                                style: robotoMedium.copyWith(
                                    ...
                                    fontSize: Dimensions.fontSizeExtraSmall -
                                        (scrollingRate *
                                            (isDesktop ? 2 : Dimensions.fontSizeExtraSmall))),
                                maxLines: 2,
                                overflow: TextOverflow.ellipsis,
                              ),
                              Row(children: [
                                Text(
                                  ...
                                  style: robotoRegular.copyWith(
                                      ...
                                      fontSize: Dimensions.fontSizeSmall -
                                          (scrollingRate *
                                              (isDesktop ? 2 : Dimensions.fontSizeSmall))),
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                ),
                                SizedBox(
                        ...
                        Image.asset(Images.restaurantCoupon,
                            height: 55 - (scrollingRate * (isDesktop ? 2 : 55)), width: 55),
                      ]),
                    );
                  },
                ),
